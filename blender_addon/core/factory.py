...
def create_plant(species, seed=None, maxPartsPerPlant=20000, tdo_library=None):
    """
    Build a PdPlant from a PlantSpecies (parsed .pla entry).
    normalize_params() fills defaults so any species runs.
    tdo_library: TdoLibrary or path to a .tdo file for name resolution.
    """
